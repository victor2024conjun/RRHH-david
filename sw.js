...
const VERSION = 'rrhh-v1.1.0';
const SHELL = ['./', './index.html', './admin.html', './colaborador.html', './manifest.json',
  './css/app.css', './js/core.js', './js/docs.js', './js/admin.js', './js/asistencia.js', './js/modulos.js', './js/analitica.js', './js/organigrama.js', './js/cumpleanos.js', './js/seleccion.js', './js/portal.js', './postulacion.html',
