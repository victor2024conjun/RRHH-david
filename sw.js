...
const VERSION = 'rrhh-v1.2.0';
const SHELL = ['./', './index.html', './admin.html', './colaborador.html', './manifest.json',
  './app.css', './core.js', './docs.js', './admin.js', './asistencia.js', './modulos.js', './analitica.js', './organigrama.js', './cumpleanos.js', './alertas.js', './seleccion.js', './portal.js', './postulacion.html',
  './logo.png', './icon-96.png', './icon-192.png', './icon-512.png'];
